        ...
        function createTable() {
            ...
            for(var i = 0; i < order.length-1; i++) {
                if(stat[i] == "In Process") {
                    table += "<tr style='height: 80px' id='row" + i + "'><td style='width: 5%'><input type='checkbox' id='selectedrow"+ i +"'></td><td style='width: 5%'>" + id[i] + "</td><td style='overflow-wrap: break-word;'><div style='height: 100%; overflow-y: auto'><textarea id='area" + i + "' style='width: 90%' rows='4' onfocusout='updateDescription(" + i + ")'>" + description[i] + "</textarea></div></td><td style='width: 15%; overflow-x: auto;'>" + file[i] + "<input type='file' id='file" + i + "' onfocusout='updateFile(" + i + ")'></td><td style='width: 12%; overflow-x: auto;'><input type='checkbox' name='detailed' " + checked[i] + " id='detailed" + i + "' onclick='updateDetailed(" + i + ")'></td><td style='width: 12%; overflow-x: auto;'><input type='number' id='extra" + i + "' min='0' max='4' value='" + extr[i] + "' style='width: 60%' onchange='updateExtraCharacter(" + i + ")'></td><td style='width: 7%; overflow-x: auto;' id = 'price" + i + "' >" + price[i] + "</td><td style='width: 15%; overflow-x: auto;'>" + artid[i] + "</td><td style='width: 10%'><input type='button' value='Delete' onclick='deleteValues(" + i + ")' style='width: 90%'></td></tr>";
                    tabcount++;
                }
            }
