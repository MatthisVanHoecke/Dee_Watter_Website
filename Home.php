  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
       <form id="modal-form1" class="form-vertical" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?> ">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="modalform2" name="modalform2" class="form-vertical" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?> ">
        <div class="md-form mb-5">
          <i class="fas fa-user prefix grey-text"></i>
        ...
        <button type="submit" class="btn btn-deep-orange" name="signup_button" id="signup_button" onClick="modal()">Sign up</button>
        </div>
        </form>
      </div>
    </div>
